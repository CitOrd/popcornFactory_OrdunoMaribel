...
class Catalog : AppCompatActivity() {
    ...
    cargarPeliculas()
        adapter = PeliculaAdapter(this,this.peliculas)
        seriesAdapter= PeliculaAdapter(this, this.series)

        var gridMovies: GridView = findViewById(R.id.movies_catalog)  as GridView
        var gridSeries: GridView = findViewById(R.id.series_catalog)  as GridView
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Movie("Big Hero 6",R.drawable.bighero6, R.drawable.headerbighero6,
            "When a devastating event befalls the city of San Fransokyo and catapults Hiro into the midst of danger, " +
                "he turns to Baymax and his close friends adrenaline junkie Go Go Tomago, neatnik Wasabi," +
                " chemistry whiz Honey Lemon and fanboy Fred. Determined to uncover the mystery, Hiro " +
                "transforms his friends into a band of high-tech heroes called ‘Big Hero 6.’",  arrayListOf<Client>()))
        peliculas.add(Movie("Inception",R.drawable.inception, R.drawable.inceptionheader,
            "Dom Cobb is a skilled thief, the absolute best in the dangerous art of extraction," +
                    ...
                    " team of specialists have to pull off the reverse: their task is not to steal an idea," +
                    " but to plant one. If they succeed, it could be the perfect crime. But no amount of " +
                    "careful planning or expertise can prepare the team for the dangerous enemy that seems " +
                    "to predict their every move. An enemy that only Cobb could have seen coming.", arrayListOf<Client>()))
        peliculas.add(Movie("Leap Year", R.drawable.leapyear, R.drawable.leapyearheader,
            "A woman who has an elaborate scheme to propose to her boyfriend on Leap Day, " +
                    ...
                    "might result in her getting engaged.", arrayListOf<Client>()))
        peliculas.add(Movie("Toy Story", R.drawable.toystory, R.drawable.toystoryheader,
            "Toy Story is about the 'secret life of toys' when people are not around. When Buzz" +
                    " Lightyear, a space-ranger, takes Woody's place as Andy's favorite toy, Woody doesn't" +
                    " like the situation and gets into a fight with Buzz. Accidentaly Buzz falls out the" +
                    " window and Woody is accused by all the other toys of having killed him. He has to go" +
                    " out of the house to look for him so that they can both return to Andys room. But while" +
                    " on the outside they get into all kind of trouble while trying to get home.", arrayListOf<Client>()))
        peliculas.add(Movie("1917",R.drawable.nineteenseventeen, R.drawable.nineteenseventeen,
            "On 6 April 1917, aerial reconnaissance has observed that the German army, which has pulled " +
                    "back from a sector of the Western Front in northern France, is not in retreat but has " +
                    "made a strategic withdrawal to the new Hindenburg Line, where they are waiting to " +
                    "overwhelm the British with artillery.", arrayListOf<Client>()))
        peliculas.add(Movie("Men in black",R.drawable.mib, R.drawable.mibheader,
            "After a government agency makes first contact with aliens in 1961, alien refugees" +
                    " live in secret on Earth by disguising themselves as humans. Men in Black (MIB) is " +
                    "a secret agency that polices these aliens, protects Earth from extraterrestrial " +
                    "threats, and uses memory-erasing neuralyzers to keep alien activity a secret. MIB " +
                    "agents have their former identities erased while retired agents are neuralyzed. ", arrayListOf<Client>()))
        ...
        series.add(Movie("Dr.Who",R.drawable.drwho, R.drawable.drwhoheader,
            "Traveling across time and space, the immortal time-lord known as &#39;The Doctor&#39;" +
                    " travels across the\n" + "universe with his many companions and his loyal shape-shifting " +
                    "space-ship: The TARDIS. The\n" + "Doctor faces many threats across many generations: " +
                    "from The Daleks, The Cybermen and his time-\n" + "lord adversary The Master to " +
                    "the sinister Davros, creator of The Daleks.", arrayListOf<Client>()))
        ...
        series.add(Movie("Suits",R.drawable.suits, R.drawable.suitsheader,
    ...
    class PeliculaAdapter: BaseAdapter{
        ...
        constructor(context: Context, peliculas:ArrayList<Movie> ){
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            image.setOnClickListener {
                var intento = Intent(context, Movie_detail::class.java)
